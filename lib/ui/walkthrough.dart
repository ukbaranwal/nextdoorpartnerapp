...
class _WalkThroughState extends State<WalkThrough> {
  ...
  void changeButtonColor(int index) {
    setState(() {
      buttonColor = walkThroughModelList[index].color;
    });
  }
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                padding:
                    EdgeInsets.only(left: 20, right: 30, top: 8, bottom: 6),
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    currentPage == walkThroughPageList.length - 1
                        ? Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => GetStarted(),
